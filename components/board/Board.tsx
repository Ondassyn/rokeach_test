...
const Board = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-8">
      <div
        className="text-white text-2xl font-bold bg-blue-800 w-full text-center py-3
        rounded-xl bg-opacity-20 flex flex-row items-center justify-between px-8"
      >
      ...
      <div className="relative flex flex-row gap-28">
        <div className="flex flex-col items-center">
          <div className="text-xl text-white font-bold">
            Терминальные ценности
          </div>
          <p className="text-white text-center font-semibold w-[30rem] mb-4 leading-tight">
